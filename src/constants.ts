...
export const COMPLETED_TASK_RETENTION_MS = 300000; // 5 minutes

export const MAX_TASKS = 1000; // Maximum number of tasks to store

export const SERVER_NAME = 'example-async-mcp';
